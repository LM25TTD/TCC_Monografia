...
\fontsize{9pt}{9pt}\selectfont
      ...
      \vspace{2mm}
      \VerbatimInput[xleftmargin=8mm,numbers=left,obeytabs=true]{sources/arquivo.cpp}
   \end{boxit}
   \caption{\it Código C++}
...
\fontsize{9pt}{9pt}\selectfont
     \begin{boxit}  % coloca o código dentro de um Box
      \vspace{2mm}
      \VerbatimInput[xleftmargin=8mm,numbers=left,obeytabs=true]{sources/calculadora.erl}
   \end{boxit}
