...
Para obtenção dos dados de posicionamento, dois artefatos necessitam estar presentes no firmware: 

\begin{itemize}
	\item Um canal serial lógico: feito utilizando a biblioteca SoftwareSerial
	\item Um parser das mensagens GPRMC: a biblioteca TinyGPS disponibilizda pela comunidade realiza esta função.
\end{itemize}
...
\subsection{Comunicação com Webservice}
