...
\addbibresource{tex_parts/tese.bib}
...
Vice-Reitor:\\ \textbf{M\'{a}rio Augusto Bessa de Figueiredo}}
\\
\textit{
...
\hspace*{0.5cm}Sistema de Segurança Veicular com uso de GPS baseado em Arduino / 
Leandro Bentes; [orientado por] Prof. Dr. Raimundo Corr\^{e}a de Oliveira - Manaus: UEA, 2013.\\
\hspace*{0.5cm}112 p.: il.; 30cm\\
...
que se tornaram amigos para todas as horas, além de poder contar com
...
também aqueles que trilharam comigo este caminho:
  ...
  Minha família, que ficou diversas vezes sem minha companhia
  ...
  Aos amigos que iniciaram comigo esta caminhada no mundo das exatas,
	...
	e adrenalina, mesmo que tenhamos trilhado diferentes caminhos
	agrade\c{c}o por poder dividir alegrias e ang\'{u}stias durante o 
	tempo em que ficamos em na faculdade.
\end {minipage}
